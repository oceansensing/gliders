 ...
 * coefficient that is then multiplied by a normalized pressure changes the
...

{
  /* Pure water is densest at 3.98 degC and 999.972 kg/m^3 -- the definition
     of the liter until 1964, and the most-quoted number in the subject. */
...

{
  ...
  /* The shipped atlas is quantized to 1e-7 in the ratio, so agreement is
  ...
  /* S* multiplies the anomaly by about 1.35 SA, so it carries a larger share
     of the quantization than SA does: 5e-8 x 1.35 x 35 is 2.4e-6 g/kg, and
